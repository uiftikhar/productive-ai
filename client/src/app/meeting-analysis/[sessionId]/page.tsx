      ...
      <ErrorBoundary
        fallback={
          <Alert variant='destructive'>
            ...
            <AlertDescription>
              There was a problem loading the analysis results. This may be due to an authentication
              issue.
              <div className='mt-2'>
...
async function AnalysisResults({ sessionId }: { sessionId: string }) {
  try {
    ...
    return <ResultVisualizationWrapper initialData={results} sessionId={sessionId} />;
  } catch (error) {
