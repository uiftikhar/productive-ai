...
export const DEFAULT_CLASSIFIER_TEMPLATE =
  InstructionTemplates.DEFAULT_CLASSIFIER.promptTemplate ||
  `
...
export const FOLLOWUP_CLASSIFIER_TEMPLATE =
  InstructionTemplates.FOLLOWUP_CLASSIFIER.promptTemplate ||
  `
...
export const SPECIALIZED_CLASSIFIER_TEMPLATE =
  InstructionTemplates.SPECIALIZED_CLASSIFIER.promptTemplate ||
  `
