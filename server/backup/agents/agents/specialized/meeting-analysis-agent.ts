/**
 * @deprecated This MeetingAnalysisAgent is deprecated and will be removed in a future version.
 * Use the specialized agents in /langgraph/agentic-meeting-analysis/agents/ instead.
 */
