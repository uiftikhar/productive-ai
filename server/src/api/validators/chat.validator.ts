...
export class ChatValidator {
   ...
   */
  static validateCreateSession(req: Request, res: Response, next: NextFunction): void {
    try {
   ...
   */
  static validateSendMessage(req: Request, res: Response, next: NextFunction): void {
    try {
   ...
   */
  static validateSessionIdParam(req: Request, res: Response, next: NextFunction): void {
    try {
   ...
   */
  static validateHistoryParams(req: Request, res: Response, next: NextFunction): void {
    try {
      const { limit, includeMetadata, beforeTimestamp, afterTimestamp } = req.query;
