/**
 *  This file now uses the new langgraph/dynamic/history-aware-supervisor.service.ts
 *
...
//   llmConnector: any; // Updated to be more generic as we transition to new system
//   agentRegistry?: any; // Updated to be more generic as we transition to new system
 ...
 */
// TODO: Recreate the chat service to work with the new agentic approach
export class ChatService {
  // private logger: Logger;
  // private userContextFacade: UserContextFacade;
  // private llmConnector: any;
  // private agentRegistry?: any;
  // private defaultHistoryLimit: number;
  // private sessions: Map<string, ChatSession> = new Map();
  // private supervisors: Map<string, HistoryAwareSupervisorService> = new Map();
  ...
  //     const supervisor = new HistoryAwareSupervisorService({
  ...
  //         // Cast agent to any type for compatibility during transition
  //         supervisor.registerAgent(agent as any);
  //       }
  //     }
  ...
  //  */
  // registerAgentWithSession(sessionId: string, agent: any): void {
  //   const session = this.getSession(sessionId);
  ...
  //   // Cast agent to any for compatibility during transition
  //   supervisor.registerAgent(agent as any);
  // }
  ...
  //     const classificationResults = agents.map((agent: any) => ({
  //       agentId: agent.id,
