...
export function securityHeaders(options: SecurityHeadersOptions = {}) {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    if (options.contentSecurityPolicy !== false) {
      const csp = typeof options.contentSecurityPolicy === 'string'
    ...
    if (options.xssProtection !== false) {
      const xssValue = typeof options.xssProtection === 'string'
    ...
    if (options.frameOptions !== false) {
      const frameValue = typeof options.frameOptions === 'string'
    ...
    if (options.referrerPolicy !== false) {
      const referrerValue = typeof options.referrerPolicy === 'string'
    ...
    if (options.permissionsPolicy !== false) {
      const permissionsValue = typeof options.permissionsPolicy === 'string'
    ...
    if (options.cacheControl) {
      const cacheValue = typeof options.cacheControl === 'string'
