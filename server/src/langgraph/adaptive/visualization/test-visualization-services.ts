...
async function testGraphHistory() {
  ...
  const snapshot3Id = graphHistory.recordSnapshot(graphId, "Added resource node");
  ...
  console.log(`Current graph has ${currentGraph.nodes.length} nodes and ${currentGraph.edges.length} edges`);
}
...
async function testConfidenceVisualization() {
  ...
  console.log(`- Average confidence: ${visualization.confidence.statistics.average.toFixed(2)}`);
  console.log(`- Trend: ${visualization.confidence.statistics.trend}`);
  console.log(`- Volatility: ${visualization.confidence.statistics.volatility.toFixed(2)}`);
...
async function testExpertiseContribution() {
  ...
  console.log(`Retrieved ${taskContributions.length} contributions for task ${taskId}`);
...
async function runTests() {
  try {
    ...
    console.log("Milestone 4 - Emergent Workflow Visualization is now complete!");
    ...
    console.log("7. AgentRelationshipVisualization - Visualizing agent relationships");
    console.log("8. CommunicationFlowVisualization - Visualizing communication flows");
    console.log("9. ExpertiseContributionVisualization - Visualizing expertise contributions");
    console.log("10. InteractiveNodeExploration - Interactive node exploration");
