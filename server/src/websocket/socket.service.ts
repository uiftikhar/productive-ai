 ...
 */
// ODO Create new chat service woith agentic flow an duse that if needed
export class SocketService {
  ...
  // constructor(server: HttpServer, chatService: ChatService, logger?: Logger) {
  ...
  //   } catch (error) {
  //     this.logger.error(
  //       `Error joining session: ${error instanceof Error ? error.message : String(error)}`,
  //     );
  //     socket.emit('error', {
  ...
  //         this.io
  //           .to(this.getSessionRoomName(payload.sessionId))
  //           .emit(SocketEvents.MESSAGE_TOKEN, {
  //             sessionId: payload.sessionId,
  //             token,
  //           });
  ...
  //         this.io
  //           .to(this.getSessionRoomName(payload.sessionId))
  //           .emit(SocketEvents.MESSAGE_RESPONSE, {
  //             success: true,
  //             sessionId: payload.sessionId,
  //             message,
  //           });
  ...
  //   socket
  //     .to(this.getSessionRoomName(sessionId))
  //     .emit(SocketEvents.TYPING_START, { userId, sessionId });
  // }
  ...
  //   socket
  //     .to(this.getSessionRoomName(sessionId))
  //     .emit(SocketEvents.TYPING_END, { userId, sessionId });
  // }
  ...
  //   socket
  //     .to(this.getSessionRoomName(data.sessionId))
  //     .emit(SocketEvents.READ_RECEIPT, {
  //       userId,
