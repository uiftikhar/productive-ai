...
describe('ResourceManager', () => {
  ...
  it('should execute cleanup functions in priority order', async () => {
    ...
    resourceManager.register('low-priority', () => { order.push(3); }, { priority: 10 });
    resourceManager.register('high-priority', () => { order.push(1); }, { priority: 100 });
    resourceManager.register('medium-priority', () => { order.push(2); }, { priority: 50 });
